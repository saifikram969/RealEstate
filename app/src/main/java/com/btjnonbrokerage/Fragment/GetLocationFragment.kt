...
class GetLocationFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
         ...
         * user has installed Google Play services and returned to the app.
         */
        val longitude = requireActivity().getSharedPreferences("user_info", 0).getString("longitude", "null")
        val latitude = requireActivity().getSharedPreferences("user_info", 0).getString("latitude", "null")
        println(longitude)
        println(latitude)
...
//            googleMap.clear()
//            googleMap.addMarker(MarkerOptions().position(it).title("Point"))
